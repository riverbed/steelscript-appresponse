...
class DownloadApp(AppResponseApp):
    ...
    def add_options(self, parser):
        ...
        parser.add_option('--source-file', dest='source_file', default=None,
                          help='source file path to export')
        parser.add_option('--dest-file', dest='dest_file', default=None,
                          help='destination file path to export')
        parser.add_option('--jobname', dest='jobname', default=None,
                          help='job name to export')
        parser.add_option('--jobid', dest='jobid', default=None,
                          help='job ID to export')
        parser.add_option('--clipid', dest='clipid', default=None,
    ...
    def main(self):
        ...
        if self.options.timerange:
            ...
            timefilter = TimeFilter(start=self.options.starttime,
