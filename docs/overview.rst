...
.. currentmodule:: steelscript.appresponse.core.appresponse


Welcome to the documentation for the SteelScript SDK for SteelCentral
AppResponse.

As in our other product-oriented SDKs, our primary interface to an
AppResponse appliance will be through the class :py:class:`AppResponse`.
