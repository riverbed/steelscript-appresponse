...
PACKETS_KEY_COLS = [u'start_time', u'end_time', u'cli_tcp.ip', u'srv_tcp.port_name']
PACKETS_VALUE_COLS = [u'avg_cifs.data_transfer_time', u'sum_srv_tcp.payload_packets',
